...
The main difference between FMCB and the multinomial regression boosting is the form of decision function. We want optimize (\ref{eq:MLR_boosting_step}) for all classes simultaneously. Since the $l_2$ target function is additive and we can rewrite the optimization in the following form:
\begin{equation}
...
\paragraph{Columns bootstrapping (FMCB-B)}
