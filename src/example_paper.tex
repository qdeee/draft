...
From the solutions family we choose the pair where $\|b_{t+1}\| = 1$. To find the decision ensemble term $h_{t+1}$ minimization of the distance with factorization component $r_{t+1}$ is performed:
\begin{equation}
